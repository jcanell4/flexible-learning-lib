 ...
 * @author josep
 */
public interface ActivityEventProcessorComposer {
    RootEventProcessor getRootEventProcessor();
    RootEventProcessor getRootEventProcessor(ActivityEventProcessorConfiguration configuration);
}
