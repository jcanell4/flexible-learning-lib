 ...
 * @author josep
 */
public class BaseEventProcessorComposer extends AutoregistryEventComponentSuppliers implements EventProcessorComposer{
    Map<String, Object> additionalData = null;
    private EventComponentConfiguration config;

    public BaseEventProcessorComposer() {
    }

    public BaseEventProcessorComposer(EventComponentConfiguration config) {
        this.config = config;
    }

    @Override
    public EventProcessor getEventProcessor() {
        return this.getEventProcessor(this.config);
    }
    ...
    public EventProcessor getEventProcessor(EventComponentConfiguration configuration) {
        ...
        eventProcessor = EventProcessorComponentFactory.instanceEventProcessor(configuration.getFullName());
