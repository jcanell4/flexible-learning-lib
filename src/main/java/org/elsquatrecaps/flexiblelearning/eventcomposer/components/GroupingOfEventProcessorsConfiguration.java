 ...
 * @author josep
 */
public interface GroupingOfEventProcessorsConfiguration extends EventComponentConfiguration{
    EventComponentConfiguration getEventDataConverterConfiguration();
    List<EventComponentConfiguration> getEventComponentConfigurationList();
    void setEventDataConverterConfiguration(EventComponentConfiguration eventDataConverterConfiguration);
}
