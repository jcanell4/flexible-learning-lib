 ...
 * @author josep
 */
public interface ResponseViewConfigData extends Component{
     ...
     */
    Map<String, ConfigurationData> getConfigurationDataMap();   
    
    /**
     * @return the componentMap
     */
    Map<String, ResponseViewConfigData> getComponentMap();
